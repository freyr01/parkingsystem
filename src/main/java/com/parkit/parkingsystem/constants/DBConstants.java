...
public class DBConstants {
    ...
    public static final String GET_COMPLETED_TICKET = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME from ticket t WHERE t.VEHICLE_REG_NUMBER=? AND t.OUT_TIME IS NOT NULL";
}
